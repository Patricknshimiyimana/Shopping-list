    ...
    render(){
        return(
            <div id="todo-tools" className={this.state.hidden ? "" : "toggle-visible"}>
                ...
                <div className={`todo-tool ${this.props.filterMode === 'all' ? 'filter' : ''}`} onClick={this.props.getAllTasks}>New items</div>
                ...
                <div className={`todo-tool ${this.props.filterMode === 'completed' ? 'filter' : ''}`} onClick={this.props.getCompletedTasks}>Shopped items</div>
                <div className={`todo-tool ${this.props.filterMode === 'uncompleted' ? 'filter' : ''}`} onClick={this.props.getUncompletedTasks}>Waiting items</div>
            </div>
        )
    }
}
